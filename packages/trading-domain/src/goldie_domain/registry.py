...
register_strategy(FailedRangeBreakReversalStrategy())
register_strategy(BollingerSqueezeBreakoutStrategy())
register_strategy(EmaAtrPullbackContinuationStrategy())
